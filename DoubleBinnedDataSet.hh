#ifndef DOUBLEBINNED_DATASET_HH
#define DOUBLEBINNED_DATASET_HH

#include "DataSet.hh" 
#include "BinnedDataSet.hh"

class DoubleBinnedDataSet {
  // Class for rectangularly binned datasets - every bin the same size. 

public: 
  DoubleBinnedDataSet (std::pair<BinnedDataSet*>& datasets,std::pair<Variable*>& vars, string n = "");
