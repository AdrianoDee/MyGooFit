...
public:
  ...
  __host__ unsigned int getFunctionIntIndex () const {return functionIntegralIdx;}
  __host__ unsigned int getFunctionPntIndex () const {return functionPointIdx;}
...
protected:
  ...
  unsigned int functionIntegralIdx; // Stores index of device integral pointer.
  unsigned int functionPointIdx; //Stores index of device point pointer.
