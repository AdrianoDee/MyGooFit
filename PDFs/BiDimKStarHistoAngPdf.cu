#include "BiDimKStarHistoAngPdf.hh"
#define JUMP 22222222
MEM_CONSTANT fptype* dev_base_bikstarhistomass[100]; // Multiple histograms for the case of multiple PDFs
  ...
  , numVars(x->numVariables())
{
  ...
  MEMCPY_TO_SYMBOL(dev_base_bikstarhistomass, dev_address, sizeof(fptype*), totalHistograms*sizeof(fptype*), cudaMemcpyHostToDevice);
  // printf("NumVars Declaration = %d \n",numVars);
