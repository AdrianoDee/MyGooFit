...
//
// MEM_CONSTANT fptype* dev_base_linhists[100]; // Multiple histograms for the case of multiple PDFs
...
//   }
//
//   fptype* myHistogram = dev_base_linhists[myHistogramIndex];
//   fptype ret = 0;
//
//   //------------------
//   //     |     |     |
...
// }
//
// MEM_DEVICE device_function_ptr ptr_to_LinHistogram = device_HistoLinearInterpolation;
//
...
//   MEMCPY_TO_SYMBOL(dev_base_linhists, dev_address, sizeof(fptype*), totalHistograms*sizeof(fptype*), cudaMemcpyHostToDevice);
//   GET_FUNCTION_ADDR(ptr_to_LinHistogram);
//   initialise(pindices);
//
//   totalHistograms++;
// }
